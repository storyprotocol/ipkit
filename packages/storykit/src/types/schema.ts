...
// generated at 2025-09-02T04:21:55.024Z
...
export interface paths {
  ...
  "/disputes": {
     ...
     *     Note: The offset pagination parameter is a v4 enhancement not available in v3.
     */
...
export interface components {
  schemas: {
    ...
    DisputeQueryOptionsHuma: {
      /** @description Field to order results by (must be blockNumber or empty as in v2) */
      orderBy?: string
      /** @description Order direction for results (asc or desc) */
      orderDirection?: string
      /** @description Pagination configuration */
      pagination?: components["schemas"]["DisputePaginationHuma"]
      /** @description Filter options for disputes (v2 compatible) */
    ...
    DisputesRequestBodyHuma: {
       ...
       */
      readonly $schema?: string
      /** @description Query options for filtering and sorting disputes (must be wrapped in options object - required but can be empty) */
      options: components["schemas"]["DisputeQueryOptionsHuma"]
    }
