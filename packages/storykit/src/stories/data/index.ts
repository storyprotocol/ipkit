...
export const MAINNET_PREVIEW_IP_ASSETS = [
...
export const AENEID_PREVIEW_IP_ASSETS = [
...
const STORY_MAINNET_IP_ASSETS_NAME = MAINNET_PREVIEW_IP_ASSETS.map((ip) => `Mainnet: ${ip}`)
const STORY_MAINNET_IP_ASSETS_MAP = Object.fromEntries(MAINNET_PREVIEW_IP_ASSETS.map((ip) => [`Mainnet: ${ip}`, ip]))

const STORY_AENEID_IP_ASSETS_NAME = AENEID_PREVIEW_IP_ASSETS.map((ip) => `Aeneid: ${ip}`)
