...
_IpKit is currently a private github package so you will need repo access and a personal access token to use_
...
IpKit requires [@tanstack/react-query](https://tanstack.com/query/latest), some components have additional dependencies including:
...
Using IpKit in your React app

### Include React Query

React Query is a dependency, you will need to wrap IpKit components with a `QueryClientProvider`, we recommend doing this once in the root of the app.
